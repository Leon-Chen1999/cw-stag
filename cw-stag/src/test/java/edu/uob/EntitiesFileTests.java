...
final class EntitiesFileTests {
  ...
  void testBasicEntitiesFileIsReadable() {
      try {
          ...
          System.out.println(firstLocation.getSubgraphs().get(0).getId().getId());
          System.out.println("....");
//          firstLocation.getSubgraphs().get(0).getNodes();
//          System.out.println(firstLocation.getSubgraphs().get(0).getNodes(false).get(0));
//          System.out.println(firstLocation.getSubgraphs().get(0).getNodes(false).get(1));
...
//            paths.get(0).getSource().getNode().getId().getId(); from location
//            paths.get(0).getTarget().getNode().getId().getId(); to location
